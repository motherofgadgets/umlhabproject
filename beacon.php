...
function process_gps() {
	...
	// Settings & variables
	$callsign = "DANAE";			// Your callsign
	$comment = "Testing RaspPi + UV-5R";		// APRS comment
	...
	$time = 09.23; //092345 day:hour:minute UTC/Z

	// Latitude 35.806262500
	$lat = $json['tpv'][0]['lat'];
